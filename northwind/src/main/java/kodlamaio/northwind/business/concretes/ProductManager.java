...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getByCategoryIdIn(List<Integer> categories) {
		...
		return new SuccessDataResult<List<Product>>( this.productDao.getByCategoryIn(categories),"Veriler Listelendi.");
	}
	...
	public DataResult<List<Product>> getByNameCategory(String productName, int categoryId) {
		...
		return new SuccessDataResult<List<Product>>( this.productDao.getByNameCategory(productName,categoryId),"Veriler Listelendi.");
	}
